...
const UrlSidebar = () => {
    ...
    <nav>
        <ul>
            ...
            <li><Link to="#">SERVICES<div className="nav-icon"><img src="src/images/services_icon.png" alt="Services Icon" /></div></Link></li>
            <li><Link to="#">CONTACT<div className="nav-icon"><img src="src/images/contact_icon.png" alt="Contact Icon" /></div></Link></li>
        </ul>
    </nav>
    )
}
